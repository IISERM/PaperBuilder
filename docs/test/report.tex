...
\includegraphics[width=250pt]{C:/Users/dhruv/Programs/Python/PaperBuilder/src/default/logo.png}\\[1cm] 
...
\begin{tabular}{|c c c|}
    ...
    \large{Harry Potter}\\ %Author's name
    
    
    \large{\textbf{Registration Number}} & - &%DON'T CHANGE THIS LINE
    \large{\textsc{Ms18300}}\\ %Author's Registration Number
    
    
        \large{\textbf{Department}} & - &%DON'T CHANGE THIS LINE
    \large{Department of \textsc{Transfiguration}} \\ %Author's Department
